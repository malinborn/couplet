import{V as $,D as p,R as B,c as q,W as H,t as m,r as x,b as J}from"./mermaid-B609I8Vk.js";import{p as Q,m as D,H as _,J as U,K as b,M as X,O as j,P as ee,Q as te,R as ne,S as oe,T as se}from"./editor-demo-BRYhMLQt.js";import"./index-QPVCzPn2.js";const ie=["sk-","pk-","ghp_","ghs_","eyJ","xox","AKIA","token-","secret-"],re=[/^https?:\/\//i,/^localhost$/i,/^true$/i,/^false$/i,/^\d+$/],ae=[/password/i,/secret/i,/token/i,/key$/i,/api_key/i,/apikey/i,/auth/i,/credential/i,/private/i];function F(e,t){if(!e)return!1;if(t){for(const o of ae)if(o.test(t))return!0}for(const o of ie)if(e.startsWith(o))return!0;if(e.length>20&&/[A-Za-z]/.test(e)&&/[0-9]/.test(e)){for(const o of re)if(o.test(e))return!1;return!0}return!1}function z(e){return e.length<20||e.length-6<14?"••••••":e.slice(0,3)+"…"+e.slice(-3)}function N(e){return e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'")?e.slice(1,-1):e}class ce extends H{constructor(t,o,n,s){super(),this.key=t,this.rawValue=o,this.lineFrom=n,this.lineTo=s}eq(t){return this.key===t.key&&this.rawValue===t.rawValue&&this.lineFrom===t.lineFrom&&this.lineTo===t.lineTo}toDOM(){const t=N(this.rawValue),o=!t,n=!o&&F(t,this.key),s=o?m("editor.env.empty_value"):n?z(t):t,i=document.createElement("span");i.className="cm-env-line";const a=document.createElement("span");a.className="cm-env-key",a.textContent=this.key;const l=document.createElement("span");l.className="cm-env-eq",l.textContent="=";const d=o?"cm-env-value cm-env-value-empty":n?"cm-env-value cm-env-value-masked":"cm-env-value",r=document.createElement("span");r.className=d,r.textContent=s;const u=document.createElement("button");return u.className="cm-env-copy",u.textContent=m("ui.copy"),u.addEventListener("mousedown",v=>{v.preventDefault(),v.stopPropagation(),navigator.clipboard.writeText(t).then(()=>{u.textContent=m("ui.copied"),setTimeout(()=>{u.textContent=m("ui.copy")},1500)}).catch(()=>{})}),i.appendChild(a),i.appendChild(l),i.appendChild(r),i.appendChild(u),i}ignoreEvent(){return!1}}const le=/^(\s*)(#.*)$/,de=/^(\s*)([A-Za-z_][A-Za-z0-9_]*)\s*=\s*(.*)$/;function I(e){const t=new B,{doc:o}=e.state;for(let n=1;n<=o.lines;n++){const s=o.line(n),i=s.text;if(!i.trim())continue;if(le.test(i)){t.add(s.from,s.from,p.line({class:"cm-env-comment"}));continue}const a=de.exec(i);if(a){if(q(e,s.from,s.to))continue;const l=a[2],d=a[3],r=new ce(l,d,s.from,s.to);t.add(s.from,s.to,p.replace({widget:r}))}}return t.finish()}const ue=$.fromClass(class{decorations;constructor(e){try{this.decorations=I(e)}catch(t){console.warn("Env preview decoration error:",t),this.decorations=p.none}}update(e){if(e.docChanged||e.viewportChanged||e.selectionSet)try{this.decorations=I(e.view)}catch(t){console.warn("Env preview decoration error:",t),this.decorations=p.none}}},{decorations:e=>e.decorations}),fe=/^(\s*)(?:(?:export|declare|typeset|local|readonly)\s+)?([A-Za-z_][A-Za-z0-9_]*)=(.*)$/;function he(e){const t=fe.exec(e);if(!t)return null;const o=t[2],n=t[3],s=e.length-n.length;if(!n)return null;let i;const a=n[0];if(a==='"'){let r=1;for(;r<n.length;){if(n[r]==="\\"){r+=2;continue}if(n[r]==='"'){r+=1;break}r++}i=r}else if(a==="'"){const r=n.indexOf("'",1);i=r===-1?n.length:r+1}else{let r=0;for(;r<n.length&&n[r]!==" "&&n[r]!=="	"&&n[r]!=="#";)r++;i=r}const l=n.slice(0,i);if(!l)return null;const d=N(l);return!d||d.startsWith("$")||d.startsWith("`")||!F(d,o)?null:{key:o,rawValue:l,valueFrom:s,valueTo:s+i}}class me extends H{constructor(t,o,n,s){super(),this.key=t,this.rawValue=o,this.from=n,this.to=s}eq(t){return this.key===t.key&&this.rawValue===t.rawValue&&this.from===t.from&&this.to===t.to}toDOM(){const t=N(this.rawValue),o=z(t),n=document.createElement("span");n.className="cm-shell-secret",n.textContent=o;const s=document.createElement("button");s.className="cm-shell-secret-copy",s.textContent=m("ui.copy"),s.addEventListener("mousedown",a=>{a.preventDefault(),a.stopPropagation(),navigator.clipboard.writeText(t).then(()=>{s.textContent=m("ui.copied"),setTimeout(()=>{s.textContent=m("ui.copy")},1500)}).catch(()=>{})});const i=document.createElement("span");return i.className="cm-shell-secret-wrapper",i.appendChild(n),i.appendChild(s),i}ignoreEvent(){return!1}}function M(e){const t=new B,{doc:o}=e.state;for(let n=1;n<=o.lines;n++){const s=o.line(n);if(q(e,s.from,s.to))continue;const i=he(s.text);if(!i)continue;const a=s.from+i.valueFrom,l=s.from+i.valueTo;t.add(a,l,p.replace({widget:new me(i.key,i.rawValue,a,l)}))}return t.finish()}const pe=$.fromClass(class{decorations;constructor(e){try{this.decorations=M(e)}catch(t){console.warn("Shell secret decoration error:",t),this.decorations=p.none}}update(e){if(e.docChanged||e.viewportChanged||e.selectionSet)try{this.decorations=M(e.view)}catch(t){console.warn("Shell secret decoration error:",t),this.decorations=p.none}}},{decorations:e=>e.decorations}),T=`flowchart LR
  A[Draft] --> B[Review]
  B --> C[Ship]
  C --> D[Watch]
