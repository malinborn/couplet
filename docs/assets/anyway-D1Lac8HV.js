import{p as D}from"./editor-demo-UkFoCeUZ.js";import"./mermaid-CKz8Oxa3.js";import"./index-B4dY-qQm.js";const r=["README.md","CLAUDE.md","auth_spec.md"],A=`couplet ${r.join(" ")}`,T=380,h=400,C=430,m=.55,$=1.3,q=320,H=42,I=350,R=700,G=1300,N=450,O=320,U=450,x=420,P=160,F=450,k=1100,W=260,j=280,K=460,z=500,V=320,Y=320,Q=480,X=180,B=420,J=1300,Z=550,aa=`
