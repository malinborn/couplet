...
> **Статус 2026-09-24: рекомендация «AI-стол» отклонена владельцем** («изолирует ИИ вместо интеграции — не couplet-way»). Актуальный дизайн: `docs/superpowers/specs/2026-09-24-tabs-design.md`. Этот отчёт остаётся как исследование: баги §1, индустрия, спайк, прожарки.
