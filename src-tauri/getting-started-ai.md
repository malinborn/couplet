...
```
AI
├── Teach Your AI mdmini          ← one prompt; your agent does the setup
...
A window should come to the front with the heading pulsing. If nothing happens, **Teach Your AI mdmini** in the AI menu has the prompt again — and `mdmini agent` prints the same instructions in the terminal.
