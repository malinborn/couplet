...
| | |
|---|---|
| **show** | Llevarte hasta una línea o frase y darle un destello breve. |
| **edit** | Reescribir el documento sobre la marcha; el tramo cambiado queda resaltado hasta que pulsas **Esc**. |
| **ask** | Dejarte botones reales en el propio documento — una opción, varias, o un campo de texto — y esperar tu respuesta. |
| **question** / **answer** | Leer los comentarios que dejas en un fragmento (**⇧⌘M**) y responder en ese mismo hilo. |

Nada ocurre a tus espaldas: **⌘Z** deshace una edición de la IA igual que deshace algo que escribiste tú, y los hilos de comentarios se guardan en un archivo markdown aparte, junto al documento, nunca dentro de él.
...
**Alineación TOC** — **Ver → Alineación TOC**. La marca de una casilla activada queda un pelín descentrada. No es un descuido de diseño: `✓` no es un símbolo simétrico, así que jamás se ve centrado, hagas lo que hagas. Si ese pelín te va a molestar el resto del día, este interruptor lo cambia por una cruz hecha de dos trazos girados sobre el mismo punto — simétrica por definición, sin nada que se pueda torcer. Nos gusta el ✓ tal como es. Pero entendemos la manía.
