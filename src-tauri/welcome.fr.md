...
| | |
|---|---|
| **show** | T'amener à une ligne ou une phrase et la faire clignoter un court instant. |
| **edit** | Réécrire le document ouvert, à la volée ; la partie modifiée reste surlignée jusqu'à ce que tu appuies sur **Esc**. |
| **ask** | Poser de vrais boutons dans le document — un choix, plusieurs, ou un champ de texte — et attendre ta réponse. |
| **question** / **answer** | Lire les commentaires laissés sur un passage (**⇧⌘M**) et répondre dans le même fil. |

Rien ne se passe dans ton dos : **⌘Z** annule une modification de l'IA exactement comme ta propre saisie, et les fils de commentaires vivent dans un fichier markdown à part, à côté du document, jamais dedans.
...
**Alignement TOC** — **Affichage → Alignement TOC**. La coche d'une case activée est décalée d'un cheveu par rapport au centre. Ce n'est pas un défaut de fabrication : `✓` n'est tout simplement pas un symbole symétrique, donc il ne paraîtra jamais centré, quoi que tu fasses. Si ce cheveu doit te hanter pour le reste de la journée, cet interrupteur le remplace par une croix faite de deux traits pivotés autour d'un même point — symétrique par construction, avec rien qui puisse dériver. On aime le ✓ tel qu'il est. Mais on connaît la manie.
